...
import { Button, Checkbox, Modal, Slider, Typography } from "antd";
import { useState } from "react";
import Cropper, { Area } from "react-easy-crop";

interface CustomProductImageCropperProps {
...
export default function CustomProductImageCropper(
  props: CustomProductImageCropperProps
) {
    ...
    >
      ...
      <div className="absolute w-11/12 h-1/2">
        ...
        <div className="mt-[50vh] grid grid-cols-2 gap-5">
          ...
          <div className="gap-5 z-50 col-span-2 flex justify-between">
            <Text>
              Tỉ lệ mẫu:{" "}
              <span className="font-semibold">{aspectRatio.label}</span>
            </Text>
            <Checkbox>Chọn làm ảnh bìa của sản phẩm</Checkbox>
